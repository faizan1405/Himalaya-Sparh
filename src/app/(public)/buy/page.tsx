      ...
      <main className="pt-24">
        <section className="py-20 lg:py-28">
          <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-3xl lg:text-4xl font-heading font-bold text-navy mb-4">Order Placed!</h1>
            <p className="text-navy/60 text-lg mb-8">Thank you for your purchase. We'll get in touch shortly to confirm your order.</p>
      ...
      <main className="pt-24">
        <section className="py-20 lg:py-28">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="bg-navy rounded-3xl p-12 lg:p-16">
      ...
      <section className="relative py-20 bg-gradient-to-b from-navy via-midnight to-navy overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <nav className="flex items-center gap-2 text-sm text-silver/50 mb-8">
            ...
            <span>/</span>
            <span className="text-glow">Buy Now</span>
          </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="aspect-square bg-gradient-to-br from-aurora/5 to-aqua/5 rounded-3xl border border-white/10 backdrop-blur-sm flex items-center justify-center overflow-hidden">
                {product.images?.[0] ? (
              ...
              <div className="flex items-center gap-4 mt-6">
                {[
                  ...
                  <div key={badge.text} className="flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 py-2 backdrop-blur-sm">
                    <badge.icon className="w-4 h-4 text-glow/80" />
            ...
            >
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-green-500/10 text-green-400 text-sm font-medium rounded-full mb-4">
                <span className="w-1.5 h-1.5 bg-green-400 rounded-full" />
                In Stock ({product.stock} units)
              </span>

              <h1 className="text-3xl lg:text-4xl font-heading font-bold text-white mb-4 leading-tight">
                {product.name}
              </h1>
              ...
              {product.features?.length > 0 && (
                <div className="mb-8">
                  <h3 className="font-heading font-semibold text-white mb-4 text-sm uppercase tracking-wider">Features</h3>
          ...
          <div className="space-y-4">
            {[
              ...
              <motion.div
                ...
                className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-silver/10"
              >
