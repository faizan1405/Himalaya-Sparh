...
import { Droplets, Flame, Shield, Box } from 'lucide-react';
...
const usageModes = [
  { icon: Droplets, title: 'Direct Use', desc: 'Works with any water source — tap, borewell, or tanker. Zero setup required.' },
  { icon: Flame, title: 'RO Purifier', desc: 'Seamlessly integrates with your existing RO system for enhanced purity.' },
  { icon: Shield, title: 'Water Dispenser', desc: 'Compatible with all standard water dispensers and coolers in offices and homes.' },
];
    ...
    <main>
      ...
      <section className="relative py-24 lg:py-32 bg-gradient-to-b from-navy via-midnight to-navy overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <h1 className="heading-lg font-display font-bold text-white mb-6 leading-tight text-balance">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="hidden lg:block sticky top-32">
              ...
              >
                ...
                <div className="relative w-full h-full bg-gradient-to-br from-aurora/10 to-aqua/5 rounded-3xl border border-white/[0.08] backdrop-blur-sm flex items-center justify-center">
                  <motion.div
                    animate={{ y: [0, -15, 0] }}
                  ...
                  >
                    ...
                    <p className="text-silver/80 font-medium">Himalya Sparsh</p>
                  ...
                  <Card glow>
                    ...
                    <div className="flex items-start gap-5">
                      ...
                      <div>
                        ...
                        <p className="text-silver/60 leading-relaxed text-sm">{step.description}</p>
                      </div>
                    </div>
                  </Card>
                </motion.div>
            ...
            {usageModes.map((mode, i) => (
              ...
              >
                <Card glow className="text-center h-full">
                  <div className="w-16 h-16 bg-gradient-to-br from-aurora/10 to-aqua/10 rounded-xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-500">
                    <mode.icon className="w-8 h-8 text-aurora" />
                  </div>
                  <h3 className="font-display font-bold text-white text-xl mb-3">{mode.title}</h3>
                  <p className="text-silver/60 leading-relaxed text-sm mb-6">{mode.desc}</p>
                  <CTAButton href="/buy" variant="ghost" className="!text-sm">Get Yours</CTAButton>
                </Card>
              </motion.div>
            ))}
          </div>
